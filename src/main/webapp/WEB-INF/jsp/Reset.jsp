                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="resetpass">
                                  ...
                                  <input id="Username" name="Username[]"  type="hidden" class="form-control"  value="${user.username}">        
                                       </c:forEach>
                                           ...
                                           <label>User Name </label>
                                             ...
                                             <div class="form-group" >
                                              <input id="uname" name="uname"  type="text" class="form-control webcampics" onblur="userFunction();"   placeholder="UserName" value=""> 
                                               <div id=usernamecheck style=display:none;color:red ><i><font size="2">User name doesn't exist</font> </i></div>
                                            </div>
                                           </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <div class="form-group" style="padding-left:20px;">
                                                ...
                                                <button id="resetpassclick" class="btn btn-info " >Save</button>
                                            </div>
                                        </div>
