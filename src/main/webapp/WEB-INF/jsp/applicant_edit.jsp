                        ...
                        <div class="card">
                            <div class="card-header">
                             <c:forEach items="${applicantList}" var="applicantList" varStatus="Index">
                                ...
                                <h5 class="title">Edit Applicant ( Exam Name :  <c:out value="${examName}"/> ) </h5>
                                
                                 <h6 class="title"></h6>
                            </div>
                            <div class="card-body">
                                <form id="examRegisterForm">
									<input type="hidden"  id="applicantPassword" name="applicantPassword" value="${applicantList.applicantPassword}" >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input id="emailId" name="emailId" type="email" class="form-control input-sm"  onfocus="emailFunction()"  onkeypress="EmailValidate()" onblur="Emailexist()"  placeholder="" value="${applicant.emailId}"/>
                                ...
                                <div class="col-md-12" >
                                    ...
                                    <input id="editApplicantButton" type="submit" value="Submit" style="padding-left:20px;margin-left:10px;" name="add" class="btn btn-success "/>
                                </div>
                                </div>
                                <br>
