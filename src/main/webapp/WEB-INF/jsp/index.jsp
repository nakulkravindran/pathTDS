...
%> 
    ...
    -->
            ...
            <div class="sidebar-wrapper boldd">
                <ul class="nav">
                    <li class="active">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title caps">T&D System - <%= session.getAttribute("uname") %> </h5><hr> 
                            ...
                            <div class="card-body all-icons">
                                <div class="row">                                  
                                   ...
                                   <!--   <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/user"><div class=" hoverdiv1 font-icon-detail">
                                            <i class="now-ui-icons ui-1_lock-circle-open"></i>
                                            <h3>Privileges</h3> 
                                        </div></a>
                                    </div>-->
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/usermangmnt"><div class="hoverdiv3 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3>User Management</h3>
                                        </div></a>
                                    </div>
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/setuppara"><div class="hoverdiv7 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3>Parameter Setup</h3>
                                        </div></a>
                                    </div>
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/manageQuestions"><div class="hoverdiv2 font-icon-detail">
                                            <i class="now-ui-icons files_paper"></i>
                                            <h3>Questions</h3>
                                        </div></a>
                                    </div>
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/exammangmnt"><div class="hoverdiv4 font-icon-detail">
                                            <i class="now-ui-icons education_hat"></i>
                                            <h3>Exams</h3>
                                        </div></a>
                                    </div>
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/viewApplicants"><div class="hoverdiv8 font-icon-detail">
                                    ...
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/viewResults">
                                        <div class="hoverdiv5 font-icon-detail">
                                     ...
                                     <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/passwordMangement">
                                        <div class="hoverdiv7 font-icon-detail">
                                            <i class="now-ui-icons ui-1_lock-circle-open"></i>
                                    ...
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/TrainingModule">
                                        <div class="hoverdiv2 font-icon-detail">
                                            <i class="now-ui-icons education_hat"></i>
