                                    ...
                                    <table class="table" style="vertical-align: middle;">
                                        ...
                                        <c:forEach items="${trainingList}" var="exam">
                                            ...
                                            <td>
                                               ...
                                               <td >
                                                    <%-- <a href="/pathTDS/TrainingRegistration?traingid=${exam.id}">Share Link</a> --%>
                                                    <a href="/pathTDS/trainingDetails?traingid=${exam.id}">Share Link</a>
                                                </td>
                                                <td >
                                                    <a href="/pathTDS/TraingAnnounceEdit?traingid=${exam.id}"><button class="btn btn-info " >Edit</button></a>
                                                </td>
