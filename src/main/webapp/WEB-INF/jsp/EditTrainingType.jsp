                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title ">Edit TrainingType   </h5>
                            </div>
                                ...
                                <form id="classeditparameter" onsubmit="return false;">
                                           ...
                                           <label>&nbsp;&nbsp;&nbsp;Enter Type: </label>
                                             ...
                                             <div class="form-group" >
                                              <input id="prm_type" name="prm_type"  type="text" class="form-control webcampics" readonly  placeholder="Type" value="Trainingtype"> 
