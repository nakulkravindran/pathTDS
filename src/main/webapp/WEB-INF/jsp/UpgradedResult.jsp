                                            ...
                                            <c:forEach items="${resultsOld}" var="result" varStatus="myIndex">
                                               <tr>
                                                   ...
                                                   <c:forEach items="${allApplicant}" var="applicant" varStatus="num">
                                                   		<c:if test="${result.applicantId eq applicant.id}">
                                                   			<td>
                                                   ...
                                                   <td>
                                                   		<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${ result.totalScore*100/maximumScore } " />                                                   
                                                   </td>
                                                   <td>
                                                   <%-- <font color="red">  <c:out value="(Pending)"/></font> --%>
                                               ...
                                               <font color="green">  <c:out value="${resultN.status}"/></font>
                                                   ...
                                                   <td>
                                                       <a href="/pathTDS/UpgradedReportCard?examId=${examId}&applicantId=${resultN.applicantId}&finalR=1">Answer Sheet</a>
                                                   </td>
                                                </tr>
                                               </c:if> 
                                            </c:forEach>
...
$("#questionPaperEditNumber").change(function(){
   ...
   // alert(questionPaperNumber);
    ...
    window.location.href = "/pathTDS/UpgradedResult?examId=" + examid;
