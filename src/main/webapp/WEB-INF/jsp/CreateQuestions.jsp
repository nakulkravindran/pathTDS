                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title"> Question Creation</h5>
                            </div>
                            <div class="card-body">
                                <form id="uploadQuestionsForm" onsubmit="return false;" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 ">
                                            ...
                                            <div id=qnype style=display:none;color:red;><i><font size="2">please enter question  type </i></font>
                                              ...
                                              <input type="hidden" id="Qn_type" name="Qn_type" value=""> 
                                        </div>
                                        <div class="col-md-4 ">
                                            <div class="form-group">
                                                <label>Class Name</label>
                                              
                                                 <input list="paramList" autocomplete="off" id="className" name="className" class="form-control validate" placeholder="Class Name" value=""  maxlength="30" onfocus="MsgFunction()">
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="form-group">
                                            <label>Section</label>
                                               <input list="sectionparamList" autocomplete="off" id="Section" name="Section" class="form-control validate" placeholder="Section" value=""  maxlength="30" onfocus="MsgFunction()">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="form-group">
                                               ...
                                               <input list="difficultyparamList" autocomplete="off" id="difficultylevel" name="difficultylevel" class="form-control validate" placeholder="Difficultylevel" value=""  maxlength="20" onfocus="MsgFunction()">
                                                  ...
                                                  <!--   <c:forEach items="${paramList}" var="diffcultpara" >
                                                    <c:if test="${diffcultpara.prm_type eq 'Difficulty level'}"> 
                                                        <option value="${diffcultpara.prm_name}"></option>
                                                        </c:if>
                                                    </c:forEach> -->
                                                </datalist>
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="form-group">
                                                <label>Area</label>
                                                <input type="text" id="area" name="area" class="form-control" placeholder="Area" value="" maxlength="250" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" id="lastoption"  style=display:none;>
                                        <div class="col-md-4 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="noneof" name="noneof" class="form-control" placeholder="Last Option Value" value="None of the above">
                                            </div>
                                        </div>
                                         </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea id="Question" name="Question" class="form-control" placeholder="Question" value="" onfocus="QuestionFunction()" onkeypress="HidedQuest()"></textarea>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                       ...
                                       <textarea id="option1" name="option1" class="form-control" placeholder="Option 1" onblur="checknulop1();"   value=""></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea id="option2" name="option2" class="form-control" placeholder="Option 2" onblur="checknulop2();" onfocus="op1ChFn();"  value=""></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea id="option3" name="option3" class="form-control" placeholder="Option 3" onfocus="op2ChFn()"  onkeypress="Hidedop3()" onblur="checknulop3();" value=""></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea id="option4" name="option4" class="form-control" placeholder="Option 4" onfocus="op3ChFn();" value=""></textarea>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <br>
                            ...
                            <div class="row" id="multpleAnswer"style=display:none;>
                                <div class="col-md-2 ">
                                    <div class="form-group">
                                        <label>Answer</label>
                             ...
                             <div class="row" id="answerdesc" style=display:none;>

                                <div class="col-md-10" >
                                    <div class="form-group">
                                        <label>Answer</label>
                                        <textarea id="answerDescrptive" name="answerDescrptive" class="form-control" placeholder="Descrptive Answer" value="" onfocus="QuestionFunction()" onkeypress="HidedQuest()"></textarea>
...
function myFunction() { //onchange event of question type
    ...
    document.getElementById("Qn_type").value = x;
   if(x=="multiple"){
	   $('#objective').show(); 
	   $('#multpleAnswer').show(); 
	   $('#lastoption').show();
	   $('#answerdesc').hide();
	   document.getElementById("option5").value = "None of the above";
   }
   else{
	   $('#answerdesc').show();  
	   $('#objective').hide();
