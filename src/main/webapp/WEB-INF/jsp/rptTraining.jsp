                            ...
                            <div class="row " style="margin-top: -1vw">
                                <div class="col-md-3" >
                                    <div class="form-group">  
                                            ...
                                            <input list="paramList" autocomplete="off" id="category" name="category" class="form-control  col-md-8 validate" placeholder="category" value=""  maxlength="30" >
                                ...
                                <div class="col-md-3" >
                                    <div class="form-group">
                                       <label><b>Attendee Company</b></label>
                                ...
                                <div class="col-md-3" >
                                    <div class="form-group">
                                       <label><b>Attendee Department</b></label>
					 	...
					 	<div class="table-responsive"  >
                              <table id="MyTable" class="table table-striped table-bordered table-sm" >
                                     ...
                                     <tbody style="text-align: left;">
                                        <c:forEach items="${rpttraining}" var="rpt" varStatus="count">
                                        <tr>
                                           	<td><c:out value="${count.index + 1}. "/></td>
                                           	<td> <c:out value="${rpt.getTrainingtype()}"/></td>
                                           	<td><c:out value="${rpt.getId()}"/></td>
                                           	<td><c:out value="${rpt.getStartdt()}"/></td>
                                           	<td><c:out value="${rpt.getPeriod()}"/></td>
                                           	...
                                           	<td><c:out value="${rpt.getAttended()}"/></td>
                ...
                <script src="assets/js/jquery.table2excel.min.js"></script>
                 ...
                 $( document ).ready(function() {
                	 ...
                	 $("#search").click(function(e){   
                         ...
                         window.location.href = "/pathTDS/rptTraining?category=" + category+ "&frmdate=" + frmDate+  "&todate=" +  toDate + "&company=" +company +"&country="+country+"&department="+department+"&name="+name+"&show="+qnshow;   
