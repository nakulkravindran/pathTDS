                       ...
                       <div id="headding">
                          ...
                          <hr>
                            ...
                            <div class="row" style="text-align:center;">
                                ...
                                <div class="col-md-3">  
                                      <a  href="/pathTDS/ViewQustnsExcel?questionPaperNumber=${questionpapermodel.questionpaperid}"><button class="btn btn-success btn-sm enableOnInput col-md-4"> Expot to Excel</button>  </a>                                  
                                ...
                                <div class="col-md-4">
                                    ...
                                    <c:if test="${editquestionpaper  eq 'true'}">
                                    <a  href="/pathTDS/QuestionPaperView?questionPaperNumber=${questionpapermodel.questionpaperid}"><button class="btn btn-danger btn-sm enableOnInput col-md-4"> Edit Question Paper</button>  </a>  
                                    </c:if>
                                </div>
                            </div>
                            ...
                            <div class="card-body" >
                              <div class="container-fuid">
                                ...
                                <c:forEach items="${questionbankList}" var="question" varStatus="count">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group" >
                                          <p style="white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;text-align: left ;align : justify; font-weight:510;line-height: 1.3;"> 
                                      ...
                                      <div class="col-md-2" >
                                        <div class="form-group">
                                           <button hidden onclick='deleteQnButtonClick("${qn.getquestionpaperqnid()}", "${qn.getScoreperquestion()}","${questionpapermodel.getQuestionpaperid()}")' class="btn btn-danger btn-sm disableOnInput " id="deleteQnButton">Delete</button>
                                        </div>
                                       </div>
