                          ...
                          View / Edit Question paper<hr>
                           ...
                           <div class="row" id="hederDetails">
                                ...
                                <div class="col-md-2" id="qestnno">
                                    <div class="form-group">
                                       <h5 >
                                       <label><b> Section 1</b></label><br>
                                       <c:out value="${questionpapermodel.getSection1()}"/>
                                       </h5>
                                    </div>
                                </div>
                                <div class="col-md-2" id="qestnno">
                                    <div class="form-group">
                                       <h5 >
                                       <label><b> Section 2</b></label><br>
                                       <c:out value="${questionpapermodel.getSection2()}"/>
                                       </h5>
                                    </div>
                                </div>
                                <div class="col-md-2" id="qestnno">
                                    <div class="form-group">
                                       <h5 >
                                       <label><b> Section 3</b></label><br>
                                       <c:out value="${questionpapermodel.getSection3()}"/>
                                       </h5>
                                    </div>
                                </div>
                                <div class="col-md-2" id="qestnno">
                                    <div class="form-group">
                                       <h5 >
                                       <label><b> Section 4</b></label><br>
                                       <c:out value="${questionpapermodel.getSection4()}"/>
                                       </h5>
                                    </div>
                                </div>
                            ...
                            <div class="row" style="text-align:center;">
                                ...
                                <div class="col-md-3">
                                   <input id="maxsc" name="maxsc" type="text" class="form-control col-md-4" placeholder="Maximum Score"   value="" maxlength="10">
                                </div>
                                <div class="col-md-2">
                                       <label><b>Maximum Time(Min)</b></label>
                                </div>
                                <div class="col-md-3">
                                    <input id="maxtm" name="maxtm" type="text" class="form-control col-md-4" placeholder="Maximum Time(Min)"   value="" maxlength="10">
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                           <button onclick='maxminsavefn("${questionpapermodel.getQuestionpaperid()}","${questionpapermodel.getTotal_score()}")'  class="btn btn-danger btn-sm disableOnInput " id="maxminsave">Edit & Save</button>
                                    </div>
                                </div>
                            </div>
                             <br>
                             ...
                             <input type="hidden" id="scChk" value="${chkScore}"> 
                            <div class="row" style="text-align:center;">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-3">
                                        <div class="form-group" id="questBankList">                                           
                                            <input list="questionbankAddList"  autocomplete="off"  id="questionBankAddNumber" name="questionBankAddNumber"  value="" class="form-control col-md-4"  placeholder="Question Bank Number" maxlength="10">
                                            <datalist id="questionbankAddList">
                                                <c:forEach items="${questionbankAddList}" var="questionbankNum" >
                                                   <option value="${questionbankNum}"></option>                                                  
                                                </c:forEach>                                                
                                            </datalist>
                                ...
                                <div class="col-md-3">                                    
                                     <input type="text" id="score" name="score" class="form-control col-md-4" placeholder="Score" value="" maxlength="10" >
                                     <div id=scErr style=display:none;color:red ><i><font size="2">You must enter a number.</font> </i></div>
                                </div>
                                <div class="col-md-2">
                                    <button onclick='addQnButtonClick("${questionpapermodel.getQuestionpaperid()}")' class="btn btn-info btn-sm enableOnInput col-md-4" id="addQnButton">Add</button>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group" >
                                          <p style="text-align: left ;align : justify; font-weight:510;line-height: 1.3;"> 
                                            ...
                                            <b><span style="white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;"><c:out value="${question.getQuestion()}"/></span></b>
                                          </p>
                 ...
                 text-align:center;
                  line-height: 1.0;
                                   ...
                                   <c:if test="${question.getQn_type() eq 'multiple'}">
                                    ...
                                    <div class="row">
                                    <div class="col-md-9">
                                        <p style="align : justify;white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;"><span style="color: red">Op1: </span> &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="row">
                                    <div class="col-md-9">
                                        <p style="align : justify;white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;"><span style="color: red">Op2: </span> &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="row">
                                    <div class="col-md-9">
                                        <p style="align : justify;white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;"><span style="color: red">Op3: </span> &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="row">
                                    <div class="col-md-9">
                                        <p style="align : justify;white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;"><span style="color: red">Op4: </span> &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <p style="align : justify;white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;"><span style="color: red">Op5: </span> &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="col-md-9">
                                       <!--   <p style="align : justify;"><span style="color: black">Answer: </span> &nbsp;&nbsp;&nbsp;
                                   		...
                                   		<b>Answer:</b> <span style="white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;line-height: 2.3"><c:out value="${question.getAnswer_Descriptive()}"/></span>
                                         </div>
...
, Ver 1.0 Beta
                ...
                $(document).ready(function(){
                	...
                	if(clkstr=="true"){
                		alert("Please select a question of same Class and Section.");
                	}
                    ...
                    var scStr= $("#scChk").val();
                    if(scStr=="true"){
                    	alert("please make sure the maximum score is less than total score.");
                     }
                });
                ...
                function maxminsavefn(questionPaperNum,totalsc){
                	var maxsc1=document.getElementById('maxsc').value;
                	var maxtm1=document.getElementById('maxtm').value;
                	var adStr="score";
                	if (maxsc1!="" && maxtm1!="" && (parseInt(maxsc1,10)<=parseInt(totalsc,10))){
                		 window.location.href = "/pathTDS/QuestionPaperView?actionStr="+adStr+ "&" +"questionPaperNumber=" + questionPaperNum + "&" +"maxscore="+maxsc1+"&" +"maxtm=" + maxtm1;
                	}else{
                		//alert("Please fill in the fields and make sure the total score is less than maximum score.");
                		alert("Please fill in all the fields and make sure that maximum score is equal to or less than total.");
                	}
                }
                </script>
              </html>
