                            ...
                            <div class="card-body all-icons">
                                <div class="row">                                  
                                    ...
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/UpgradeScoreSearch"><div class="hoverdiv7 font-icon-detail">
                                            <i class="now-ui-icons ui-1_lock-circle-open"></i>
                                            <h3>Score Descriptive Answers</h3> 
                                        </div></a>
                                    </div>
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/UpgradedResult"><div class="hoverdiv2 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3>View Result </h3> 
                                        </div></a>
                                    </div>                                    
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/UpgradedResultEdit"><div class="hoverdiv4 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3>Edit Result</h3>
                                        </div></a>
                                    </div> 
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/UpgradedResultCons"><div class="hoverdiv3 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3>Final Results</h3>
                                        </div></a>
                                    </div>                                    
                                    ...
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/rptExam"><div class="hoverdiv7 font-icon-detail">
                                            <i class="now-ui-icons files_paper"></i>
                                            <h3>Exam Report</h3> 
                                        </div></a>
                                    </div>
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/rptMonitor"><div class="hoverdiv2 font-icon-detail">
                                            <i class="now-ui-icons files_paper"></i>
                                            <h3>Monitor Exam </h3> 
                                        </div></a>
                                    </div>                                    
