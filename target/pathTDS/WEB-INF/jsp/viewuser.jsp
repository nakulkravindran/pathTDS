            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" >USER: <%= session.getAttribute("uname") %></a>
                    </div>
                                    ...
                                    <table class="table" style="vertical-align: middle;">
                                        <thead class=" text-primary" style="font-weight:400;font-size:17px; background-color: #3498db ">
                                           ...
                                           <!--  <th style="font-weight:400;font-size:17px;width: 22px;">
                                            ...
                                            <th style="font-weight:400;font-size:17px;text-align:justify ">Email Id</th>
                                             <th style="font-weight:400;font-size:17px;text-align:justify ">Current Status</th>
                                             <th ></th>
                                              <th></th>
                                              <th></th>
                                        </thead>
                                            ...
                                            <td>
                                               ...
                                               <td>
                                                ...
                                                <input type="hidden" id="userId" >
                                                    <a href="/pathTDS/editUser?userid=${user.id}"><button class="buttons3" >Edit</button></a>
                                                ...
                                                .buttons3 {
                                                 ...
                                                 <c:if test="${user.status eq 'Active'}">
                                                  <button id="status" onclick='deleteButtonClick("${user.id}")' class="buttons1" >Deactivate</button>
                                                  </c:if>
                                                  <c:if test="${user.status eq 'Inactive'}">
                                                  <button id="status" onclick='deleteButtonClick("${user.id}")' class="buttons2">Activate</button>
                                                  </c:if>
                                                
                                                </td>
                                                <td >
                                                <input type="hidden" id="userId" >
                                                    <button onclick='UsersdeleteClick("${user.id}")' class="btn btn-danger btn-sm " >Delete</button>
...
<script>
     ...
     <script>
     function UsersdeleteClick(userId){
    	
    	var delVal = confirm("Are you sure to delete this user ?. Click 'OK' to confirm.");
    	if(delVal==true){
    	var url="/pathTDS/deleteuser";
     	    $.ajax({
     	        type: "GET",
     	        url: url,
     	        data: {userId: userId}, // pass userid to controller.
