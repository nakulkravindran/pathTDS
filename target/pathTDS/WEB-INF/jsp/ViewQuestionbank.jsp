                                ...
                                <c:forEach items="${questionsList}" var="question" varStatus="count">
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <c:out value="${question.question}"/>
                                          ...
                                          <span style="white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;align : justify; font-weight:510;line-height: 2.3;"><c:out value="${count.index + 1}. "/> <span style="color: red">Q: </span>&nbsp; <c:out value="${question.question}"/></span>
                                     ...
                                     <div class="col-md-2" id="time">
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                          <p>
                                             <label>Date</label>
                                           <c:out value="${question.createddate}"/>
                                           </p>
                 ...
                 text-align:center;
                  line-height: 1.0;
                                   ...
                                   <div>
                                      <div class="row">
                                    <div class="col-md-9">
                                        <p style="align : justify;align : justify;"><span style="color: red">Op1: </span> &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="row">
                                    <div class="col-md-9">
                                        <p style="align : justify;align : justify;"><span style="color: red">Op2: </span> &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="row">
                                    <div class="col-md-9">
                                        <p style="align : justify;align : justify;"><span style="color: red">Op3: </span> &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="row">
                                    <div class="col-md-9">
                                        <p style="align : justify;align : justify;"><span style="color: red">Op4: </span> &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <p style="align : justify;align : justify;"><span style="color: red">Op5: </span> &nbsp;&nbsp;&nbsp;
                                          <span style="white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;"><c:out value="${question.op5}"/></span></p>
                                    ...
                                    <div class="col-md-9">
                                       <!--   <p style="align : justify;"><span style="color: black">Answer: </span> &nbsp;&nbsp;&nbsp;
                                   		...
                                   		<b>Answer:</b> <span style="white-space:pre-wrap;word-wrap:break-word;-ms-word-wrap:break-word;overflow-wrap:break-word;line-height: 2.3"><c:out value="${question.answer_Descriptive}"/></span>
                                         </div>
                              ...
                              <table id="MyTable" class="table table-sm" >
                                  ...
                                  <tbody style="text-align: left;">
                                        ...
                                        <tr>
                                           	...
                                           	<td><c:out value="${question.qn_type}"/></td>
                                           	<td><c:out value="${question.class_name}"/></td>
                                           	<td><c:out value="${question.status}"/></td>
                                           	<td><c:out value="${question.section}"/></td>
                                           	<td><c:out value="${question.time_per_question}"/></td>
                                           	<td><c:out value="${question.area}"/></td>
                                           	<td><c:out value="${question.difficultylevel}"/></td>
                                           	<td><c:out value="${question.createddate}"/></td>
                                           	<td><c:if test="${question.qn_type eq 'multiple'}">  <c:out value="${question.answer_multiple}"/> </c:if> 	</td>
                                           	<td><c:if test="${question.qn_type eq 'descriptive'}">  <c:out value="${question.answer_Descriptive}"/> </c:if></td>
                                           	<td><c:if test="${question.qn_type eq 'multiple'}">  <c:out value="${question.op1}"/> </c:if></td>
                                           	<td><c:if test="${question.qn_type eq 'multiple'}">  <c:out value="${question.op2}"/> </c:if></td>
                                           	<td><c:if test="${question.qn_type eq 'multiple'}">  <c:out value="${question.op3}"/> </c:if></td>
                                           	<td><c:if test="${question.qn_type eq 'multiple'}">  <c:out value="${question.op4}"/> </c:if></td>
                                           	<td><c:if test="${question.qn_type eq 'multiple'}">  <c:out value="${question.op5}"/> </c:if></td>
                 ...
                 $( document ).ready(function() {
                	 ...
                	 $("#search").click(function(e){                		
                         ...
                         var qn2=$("#qnNumber2").val();
                          window.location.href = "/pathTDS/ViewQuestionbank?Qn_type=" + qntype+ "&classname=" + classname+  "&qnstatus=" +  qnstatus + "&area=" +area +"&frmdate="+frmdate+"&todate="+todate+"&frmqn="+qn1+"&toqn="+qn2;   
                	 });
