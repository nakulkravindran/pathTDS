                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title ">Training Type </h5>
                            </div>
                            <div class="card-body" style="margin-top: 2vw">
                                <form id="Typeparameter">
                                           ...
                                           <label>&nbsp;&nbsp;&nbsp;Enter Type: </label>
                                             ...
                                             <div class="form-group" >
                                              <input id="prm_type" name="prm_type"  type="text" class="form-control webcampics" readonly  placeholder="Type" maxlength="30" value="Trainingtype"> 
                                              ...
                                              <thead  class=" text-primary" style="font-weight:400;font-size:17px; background-color: #3498db ">
                                                ...
                                                <tbody>
                                                 ...
                                                 <c:forEach items="${paramList}" var="parmeter" >
                                                   <c:if test="${parmeter.prm_type eq 'Trainingtype'}"> 
                                                ...
                                                <td style="padding-left:20px;"><%=i %></td>
                                                 ...
                                                 <td> 
                                                 <a href="/pathTDS/EditTrainingType?userid=${parmeter.id}"><button class="btn btn-info btn-sm" >Edit</button></a>&nbsp;&nbsp;
...
<script src="js/TrainingType.js"></script>
<script>
