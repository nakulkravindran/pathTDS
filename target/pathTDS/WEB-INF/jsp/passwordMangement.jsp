                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title">PASSWORD MANAGEMENT </h5>
                                <hr>
                            </div>
                            <div class="card-body all-icons">
                                <div class="row">                                  
                                    ...
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/Changepass"><div class="hoverdiv2 font-icon-detail">
                                            <i class="now-ui-icons ui-1_lock-circle-open"></i>
                                            <h3>Change Password</h3> 
                                        </div></a>
                                    </div>
                                   <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/Reset"><div class="hoverdiv6 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
