                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title ">Evaluation Ratings  </h5>
                            </div>
                                ...
                                <form id="classparameter">
                                        ...
                                        <div class="row">
                                           ...
                                           <label>&nbsp;&nbsp;&nbsp;Indicator Name: </label>
                                             ...
                                             <div class="form-group" >
                                              ...
                                              <input id="prm_shortname" name="prm_shortname"  type="text" class="form-control"  maxlength="30"  placeholder="Name" value="" >
                                            </div>
                                           </div>
                                        </div>
                                         <br>
                                        <div class="row">
                                           ...
                                           <label>Indicator Value:</label>
                                             ...
                                             <div class="col-md-3 "style="padding-left:0px;">
                                             <div class="form-group" >
                                              <input id="prm_sort" name="prm_sort"  type="text" class="form-control" maxlength="2"    placeholder="Short Name" value="">
                                     ...
                                     <table class="table"  style="vertical-align: middle;" >
                                              <thead class=" text-primary" style="font-weight:400;font-size:17px; background-color: #3498db ">
                                                ...
                                                <td style="padding-left:20px;"><%=i %></td>
                                                 ...
                                                 <td > 
                                                 <a href="/pathTDS/editTraining?userid=${parmeter.id}"><button class="btn btn-info btn-sm" >Edit</button></a>&nbsp;&nbsp;
