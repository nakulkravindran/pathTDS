                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title">PARAMETER SETUP </h5>
                                <hr>
                            </div>
                            <div class="card-body all-icons">
                                <div class="row">                                  
                                    ...
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/parameter"><div class="hoverdiv4 font-icon-detail">
                                            <i class="now-ui-icons ui-1_lock-circle-open"></i>
                                            <h3>Class</h3> 
                                        </div></a>
                                    </div>
                                   <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/sectionpara"><div class="hoverdiv5 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3>Section</h3> 
                                        </div></a>
                                    </div>
                                    <!-- <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/difficulylevel"><div class="hoverdiv6 font-icon-detail">
                                            <i class="now-ui-icons files_paper"></i>
                                            <h3>Difficulty level</h3>
                                        </div></a>
                                    </div>-->
                                  <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/trainingEval"><div class="hoverdiv7 font-icon-detail">
                                            <i class="now-ui-icons files_paper"></i>
                                      ...
                                      <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/TrainingType"><div class="hoverdiv3 font-icon-detail">
                                            <i class="now-ui-icons files_paper"></i>
                                            <h3>Training Type</h3>
                                        </div></a>
                                    </div> 
