                                    ...
                                    <table class="table" style="vertical-align: middle;">
                                        <thead class=" text-primary" style="font-weight:400;font-size:17px; background-color: #3498db ">
                                          ...
                                          <th style="font-weight:400;font-size:17px;text-align:justify"  >
                                            ...
                                            <th style="font-weight:400;font-size:17px;text-align:justify">
                                                ExamDate<br> (yyyy-mm-dd)
                                            </th>
                                            <th style="font-weight:400;font-size:17px;text-align:justify">
                                                LastDateOf <br>Registration<br> (yyyy-mm-dd)
                                            </th>
                                            <th style="font-weight:400;font-size:17px;text-align:justify" >
                                                Exam Time
                                            </th>
                                        ...
                                        <c:forEach items="${examList}" var="exam">
                                            <tr>
                                             <td>
                                                ...
                                                <td >
                                                    <a href="/pathTDS/registrationDetails?examId=${exam.examId}">Share Link</a>
                                                </td>
                                                <td >
                                                    <a href="/pathTDS/editExam?examId=${exam.examId}"><button class="btn btn-info " >Edit</button></a>
                                                </td>
                                                  <%i=i+1; %>
                                            </tr>
                                        </c:forEach>
