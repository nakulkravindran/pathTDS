                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title ">Edit section parameters  </h5>
                            </div>
                                ...
                                <form id="classeditparameter" onsubmit="return false;">
                                        ...
                                        <div class="row">
                                           ...
                                           <label>&nbsp;&nbsp;&nbsp;Enter section Name: </label>
                                             ...
                                             <div class="col-md-3 " style="padding-left:0px;">
                                             <div class="form-group" >
                                              <input id="prm_name" name="prm_name"  type="text" class="form-control"   placeholder="Name" value="" >
                                            </div>
                                           </div>
                                        </div>
                                         <br>
                                        <div class="row">
                                           ...
                                           <label>Enter section code:</label>
                                             ...
                                             <div class="col-md-3 " style="padding-left:0px;">
                                             <div class="form-group" >
                                              <input id="prm_shortname" name="prm_shortname"  type="text" class="form-control"   placeholder="Short Name" value="">
...
<script>
    ...
    $("#prm_name").val("${paramList.prm_name}");
