                    ...
                    <div class="col-md-12">
                        <div class="card scrollmenu">
                            ...
                            <div class="card-header">
                               <c:forEach items="${ExamNumberList}" var="Examssid" varStatus="myIndex">
                                            <input type="hidden" id="exmsid" name="exmsid[]" value="${Examssid}">
                                            
                                            </c:forEach>
                                  <label>&nbsp;&nbsp;Exam Id</label>
                                            <input list="ExamNumberList"  autocomplete="off"  id="examlistedit" name="examlistedit" value="" class="form-control col-md-2"  placeholder="Exam Id">
                                    ...
                                    <table class="table" style="vertical-align: middle;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:out value="${examList.examId}"/>
                                                </td>
                                                <td>
                                                    <c:out value="${examList.examName}"/>
                                                </td>
                                                <td>
                                                    <c:out value="${examList.examDate}"/>
                                                </td>
                                                <td>
                                                    <c:out value="${examList.finalExamDate}"/>
                                                </td>
                                                <td >
                                                    <c:out value="${examList.examTime}"/>
                                                </td>
                                                
                                                <td >
                                                    <a href="/pathTDS/registrationDetails?examId=${examList.examId}">Share Link</a>
                                                </td>
                                                <td >
                                                    <a href="/pathTDS/editExam?examId=${examList.examId}"><button class="btn btn-info " >Edit</button></a>
                                                </td>
                                            </tr>
