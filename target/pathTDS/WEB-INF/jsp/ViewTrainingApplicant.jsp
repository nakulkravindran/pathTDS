                            ...
                            <div class="card-body" >
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="row">   
                                    ...
                                    <div class="col-md-3">
                                        <br><br>
                                        <p style="color:#2CA8FF;font-weight:600;font-size:17px;">Training mode :<span style="color:red;font-weight:400;font-size:17px;">  <c:out value="${TrainingType}"/></span></p>
                                    </div>
                                    <div class="col-md-3">
                                        <br><br>
                                    ...
                                    <table id="applicantTable" class="table table-sm">
                                        ...
                                        <tbody>
                                           <c:forEach items="${applicantList}" var="applicantData" varStatus="myIndex">
                                               ...
                                               <td>                                               
                                               <a href="/pathTDS/TrainingRegistrationedit?traingapplicantid=${applicantData.id}"><b>Edit</b></a>                                                
                                               </td>
                                               <td>
                                                <select id="applicantStatus${applicantData.id}" class=".applicantStatus${applicantData.id}" name="${applicantData.id}" >
                                                  ...
                                                  <c:if test="${applicantData.approvalStatus eq 'Approved' && applicantData.attendance ne 'Yes'}"> 
                                                    <option id="Rejected${applicantData.id}" value="Rejected" >Rejected</option>
                                                    ...
                                                    <c:if test="${applicantData.approvalStatus eq 'Reject'}"> 
                                                    <option id="Approved${applicantData.id}" value="Approved" >Approved</option>
                                                    <option id="Pending${applicantData.id}" value="Pending" >Pending</option>
                                                    </c:if>
                                                    
                                                     <c:if test="${applicantData.approvalStatus eq 'Pending'}"> 
                                                    <option id="Approved${applicantData.id}" value="Approved" >Approved</option>
                                                    <option id="Rejected${applicantData.id}" value="Rejected" >Rejected</option>
                                                    </c:if>
                                               </select>
