                ...
                <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="title"> Question Upload</h5>
                                            </div>
                                            <div class="card-body" style="margin-top: -3vw">
                                                <form id="uploadExcel">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <label id="uploadQuestionsimg" class="file btn-bs-file btn btn-md btn-info" style=color:#fff >
                                                            Add File &nbsp;&nbsp;
                                                            <input style="width:120px" id="uploadButton" class="upload-file-input" type="file" name="excelFile" accept="*" />
...
a {
    color: hotpink;
                                                       ...
                                                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                         <a href="assets/img/Book1.xlsx" download>Download Excel Format Now !!</a>
