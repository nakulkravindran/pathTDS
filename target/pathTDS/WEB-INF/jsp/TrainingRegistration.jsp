                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-xs-12"> 
                                    ...
                                    <input id="remarks" name="remarks" type="text" class="form-control input-sm"  placeholder=""/><br>
                                    </div><br>
                                <div class="row">
                                <div class="col-md-12" >
                                   <input hidden name="trainingid" id="trainingid" value="${traid}" >
                                   <input hidden name="Email" id="Email" value="" >
                                    <input id="TrainingRegisterButton" type="submit" value="Submit" style="padding-left:20px;margin-left:10px;" name="add" class="btn btn-success "/>
                                </div>
                                </div>
                                <br>
...
<script>
$("#TrainingRegisterButton").click(function(e){
	e.preventDefault();
	...
	if(delVal==true){
	    ...
	    if(checked=="true"){
	     ...
	     if(candidateName !=""&&companyName!=""&&location!=""&&department!=""&&jobTitle!=""&&emailId!=""&&emailId1!=""&&y!=""&&z!=""){
	          ...
	          $("#Email").val(emailId);	          
         var url = "/pathTDS/registerTrainingApplicant";
          ...
          $.ajax({
             ...
             success: function(data)
             {
                ...
                /* if(data === "success"){
                 ...
                 window.location.href = "/pathTDS/regitrainingsuccess";
             },
             error: function(data){
              console.log("error");
             }
