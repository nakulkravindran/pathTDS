                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
								...
								<div class="col-md-2">
								<input disabled="disabled" id="employeid" name="employeid" type="text" class="form-control input-sm" onblur="HideEm()" placeholder="Employee ID"/>
                                ...
                                <div class="col-md-4">
                                   ...
                                   <font color="#007bff"> Candidate Name</font>
                                    <input id="candidateName" name="candidateName" type="text" class="form-control input-sm"  onfocus="checkFunction()" onblur="Hidedname()" placeholder=""/>
                                    </div>
                                   ...
                                   <font color="#007bff"> Bank/Company Name</font>
                                    <input id="companyName" name="companyName" type="text" class="form-control input-sm"  onfocus="nameFunction()" onblur="Hidecmpnyname()" placeholder="" />
                                    </div>
                                  ...
                                  <font color="#007bff">  Country of Bank/Company </font> 
                                    <input id="location" name="location" type="text" class="form-control input-sm"  onfocus="countrynameFunction()" onblur="Hidecntryname()" placeholder=""/>
                                  ...
                                  <font color="#007bff">  Department</font>
                                    <input id="department" name="department" type="text" class="form-control input-sm" onfocus="departFunction()"  onblur="Hidedeptname()" placeholder=""/>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input id="jobTitle" name="jobTitle" type="text" class="form-control input-sm"  onfocus="jobtitleFunction()" onblur="Hidejob()" placeholder=""/>
                                    <div id="job" style=display:none;color:red ><i><font size="2">please enter job title </font> </i></div>
                                    </div><br>
                                    <div class="col-xs-12"> 
                                    <font color="#007bff">Email ID</font>
                                    <input id="emailId" name="emailId" type="email" class="form-control input-sm"  onfocus="emailFunction()"  onkeypress="EmailValidate()" onblur="Emailexist()"  placeholder=""/>
                                ...
                                <div class="col-md-4">
                                   ...
                                   <font color="#007bff"> Line Manager</font>
                                    <input disabled="disabled" id="lineManager" name="lineManager"    type="text" class="form-control input-sm"  onfocus="emplyidFunction()" onblur="Hideemid()"  placeholder=""/>
                                   ...
                                   <font color="#007bff"> Line Manager Email ID</font>
                                    <input disabled="disabled" id="lineManagerEmail" name="lineManagerEmail" type="text" class="form-control input-sm" onfocus="lineFunction()" onblur="Hideline()" placeholder=""/>
                                 ...
                                 <font color="#007bff"> Year</font> <input disabled="disabled" id="serviceDurationYear" name="serviceDurationYear" type="number" class="form-control input-sm col-md-3"  onfocus="lineemailFunction()" onblur="Hidelineemail()" onchange="yearFunction()"  placeholder="Year"/>
                                     &emsp;&emsp;
                                     <font color="#007bff"> Month</font><input disabled="disabled" id="serviceDurationMonth" name="serviceDurationMonth" type="number" class="form-control input-sm col-md-3"  onfocus="lineemailFunction()" onblur="Hidelineemail()" onchange="monthFunction()" placeholder="Month"/>
