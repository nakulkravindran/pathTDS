                                ...
                                <form id="classparameter">
                                           ...
                                           <label>&nbsp;&nbsp;&nbsp;Enter Type: </label>
                                             ...
                                             <div class="form-group" >
                                              <input id="prm_type" name="prm_type"  type="text" class="form-control webcampics" readonly  placeholder="Type" maxlength="30" value="class"> 
                                        ...
                                        <div class="row">
                                           ...
                                           <label>&nbsp;&nbsp;&nbsp;Enter Class Name: </label>
                                             ...
                                             <div class="form-group" >
                                              ...
                                              <input id="prm_name" name="prm_name"  type="text" class="form-control"   placeholder="Name" maxlength="30" value="" >
                                            </div>
                                           </div>
                                        </div>
                                         <br>
                                        <div class="row">
                                           ...
                                           <label>Enter Short Name:</label>
                                             ...
                                             <div class="col-md-3 " style="padding-left:0px;">
                                             <div class="form-group" >
                                              <input id="prm_shortname" name="prm_shortname"  type="text" class="form-control" onblur="checkFunction()"  placeholder="Short Name" maxlength="6" value="">
                                    ...
                                    <%int i=1; %>
                                              <table class="table" style="vertical-align: middle;height: 50px;">
                                              <thead  class=" text-primary" style="font-weight:400;font-size:17px; background-color: #3498db ">
                                                ...
                                                <tbody>
                                                 ...
                                                 <c:forEach items="${paramList}" var="parmeter" >
                                                   <c:if test="${parmeter.prm_type eq 'class'}"> 
                                                     <input  type="hidden" id="clsname" name="clsname[]" value="${parmeter.prm_name}">
                                                <tr>
                                                ...
                                                <td style="padding-left:20px;"><%=i %></td>
                                                 ...
                                                 <td > <c:out value="${parmeter.prm_name}"/> </td>
                                                 <td ><c:out value="${parmeter.prm_shortname}"/></td>
                                                 <input type="hidden" name=checkshort[]  id=checkshort   value="${parmeter.prm_shortname}">
                                                  <c:if test="${parmeter.prm_status ne 'Active'}"> 
                                                 <td> 
                                                 <a href="/pathTDS/editclasspara?userid=${parmeter.id}"><button class="btn btn-info btn-sm" >Edit</button></a>&nbsp;&nbsp;
...
<script src="js/classparam.js"></script>
<script>
