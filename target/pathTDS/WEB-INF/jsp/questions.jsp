                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title caps">Questions Management </h5><hr>	
                            ...
                            <div class="card-body all-icons">
                                <div class="row">                                  
                                   ...
                                   <!--   <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/uploadQuestions"><div class="hoverdiv5 font-icon-detail">
                                            <i class="now-ui-icons ui-1_lock-circle-open"></i>
                                     ...
                                     <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/uploadQuestionsFromExcel"><div class="hoverdiv6 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3>Upload Question Paper From Excel</h3>
                                        </div></a>
                                    </div>                                    
                                    
                                   <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/Questionsview"><div class="hoverdiv3 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                    ...
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/editQuestions"><div class="hoverdiv7 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3>Edit Questions</h3>
                                        </div></a>
                                    </div>-->
                                    <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/QuestionPaper"><div class="hoverdiv4 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                      ...
                                      <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/ViewQustnPaper"><div class="hoverdiv2 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3>View/Edit Question paper</h3>
                                        </div></a>
                                    </div>
                                     <div class="font-icon-list col-md-4 ">
                                        <a href="/pathTDS/Questionsbank"><div class="hoverdiv7 font-icon-detail">
                                            <i class="now-ui-icons users_single-02"></i>
                                            <h3> Question Bank</h3>
                                        </div></a>
                                    </div>
