                     ...
                     <div>
                      <div class="card-header">
                       ...
                       <div id="headding"> <p class="ribbon2" style="height: 50px; padding-top:15px;" >
                          ...
                          View/Edit Questions<hr>
                            </p></div>
                           
                         <!--  <c:forEach items="${ResultPaperNumberList}" var="questionPaperNumber" varStatus="Index">
                                            <input type="text" id="qstpaperno" name="qstpaperno[]" value="${questionPaperNumber}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <c:forEach items="${questionPaperNumberList}" var="questionPaperNumber" varStatus="myIndex">
                                            ...
                                            <input list="questionPaperNumberList"  autocomplete="off"  id="questionPaperEditNumber" name="questionPaperEditNumber" onchange="Resultfunction();" value="" class="form-control col-md-4"  placeholder="Question Paper Number">
                                    ...
                                    <div class="col-md-8">
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                          ...
                                          <button onclick='deleteButtonClick("${question.questionId}", "${questionPaperNumber}")' class="btn btn-danger btn-sm disableOnInput" id="deleteButton">Delete</button>
...
, Ver 1.0 Beta
                ...
                <script>
                    function deleteButtonClick(questionId, questionPaperNumber){
                        var retVal = confirm("Are you sure to delete this question ?. Click 'OK' to confirm.");
                        if(retVal == true){
                            window.location.href = "/pathTDS/editQuestions?questionId=" + questionId + "&" + "questionPaperNumber=" + questionPaperNumber;
                        }
                    }
                </script>
                 <script>
                    function editButtonClick(questionId){
                    	window.location.href="/pathTDS/updateQuestion?questionId=" + questionId ;
                ...
                function printQuestions() {
                    ...
                    popupWin.document.write("<p style=text-align:center;font-size:30><b>Questions</b></p>");
