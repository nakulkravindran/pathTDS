                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title ">Satisfaction </h5>
                            </div>
                                ...
                                <form id="classparameter">
                                           ...
                                           <label>&nbsp;&nbsp;&nbsp;Enter Type: </label>
                                             ...
                                             <div class="form-group" >
                                              <input id="prm_type" name="prm_type"  type="text" class="form-control webcampics" readonly  placeholder="Type" value="Satisfaction Survey"> 
                                              ...
                                              <thead class=" text-primary" style="font-weight:400;font-size:17px; background-color: #3498db ">
                                                ...
                                                <tbody>
                                                 ...
                                                 <c:forEach items="${paramList}" var="parmeter" >
                                                   <c:if test="${parmeter.prm_type eq 'Satisfaction Survey'}"> 
                                                ...
                                                <td style="padding-left:20px;"><%=i %></td>
                                                 ...
                                                 <td><c:out value="${parmeter.prm_sort}"/></td>
                                                  <c:if test="${parmeter.prm_status ne 'Active'}"> 
                                                 <td > 
                                                 <a href="/pathTDS/editsatisfact?userid=${parmeter.id}"><button class="btn btn-info btn-sm" >Edit</button></a>&nbsp;&nbsp;
...
<script src="js/satisEval.js"></script>
<script>
                        ...
                        //	window.location = "/pathTDS/viewuser?userId=" + userId ;
                             var url="/pathTDS/deletepara";
                        	    $.ajax({
                        	        ...
                        	        {
                        	        	//alert("sucess");
                        	        window.location.href = "/pathTDS/satisfaction";
