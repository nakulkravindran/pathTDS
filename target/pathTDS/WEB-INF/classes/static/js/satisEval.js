$("#classparamclick").click(function(e){
	...
	if(type!=""&&name!=""&&sort!=""){
     ...
     $.ajax({
         ...
         success: function(data) {
             ...
             if (data !== null) {
              ...
              alert("Satisfaction survey details added sucessfully");
     ...
     function updateclass(userid) {
    	...
    	if(type!=""&&name!=""&&sort!=""){
    var url = "/pathTDS/settsatisfact?userId=" + userid;
       ...
       $.ajax({
           ...
           success: function(data) {
               ...
               if (data !== null) {
                ...
                alert("Satisfaction survey details updated successfully.");
                window.location.href = "/pathTDS/satisfaction";
               }
              },
              error: function(data) {
